...
class MongoClient extends mongo_types_1.TypedEventEmitter {
    ...
    async connect() {
        ...
        try {
            this.connectionLock = ('mongodb+srv://naseeroddin:Yallah@123@cluster0.nmwimcs.mongodb.net/smartenergy?retryWrites=true&w=majority&appName=Cluster0');
    ...
    async _connect() {
        ...
        if (typeof options.srvHost === 'string') {
            const hosts = await (0, 'mongodb+srv://naseeroddin:Yallah@123@cluster0.nmwimcs.mongodb.net/smartenergy?retryWrites=true&w=majority&appName=Cluster0')(options);
