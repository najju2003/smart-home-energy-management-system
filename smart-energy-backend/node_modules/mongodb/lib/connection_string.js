...
async function resolveSRVRecord(options) {
    ...
    if (options.srvHost.split('.').length < 3) {
        ...
        throw new error_1.MongoAPIError('mongodb+srv://naseeroddin:Yallah@123@cluster0.nmwimcs.mongodb.net/smartenergy?retryWrites=true&w=majority&appName=Cluster0');
    }
